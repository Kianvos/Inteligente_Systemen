...
public class View {
    ...
    public View(String title, String game, int size) {
        this.menuView = new MenuView();
        this.gameView = new GameView(game, size);
...
class GameView extends JPanel {
    ...
    public GameView(String game, int size) {
    ...
    public void setupGameView(String game) {
        setupTextfield(game);
        setupTopPanel();
        setupButtons();
    }
     ...
     * Sets up textfield
     */
    public void setupTextfield(String game) {
